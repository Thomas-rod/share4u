...
# contact = Social.create!(name: "contact", url_desktop_begin:"", url_mobile_begin: "placeholder_two", kind: "contact")
...
instagram_social = Social.find_by(name: "instagram").update(header: "Ajoute ton pseudo Instagram", explanation: "Ouvre Instagram et rend toi sur ton profile. Ton username est tout en haut")
facebook_social = Social.find_by(name: "facebook").update(header: "Ajoute le lien de ton profil Facebook", explanation: "Ouvre www.facebook.com et rend toi sur ton profile. Copie & colle le lien")
snapchat_social = Social.find_by(name: "snapchat").update(header: "Ajoute ton pseudo Snapchat", explanation: "Ouvre Snapchat et rend toi sur ton profile. Ton username se trouve en dessous de ton pseudo (le deuxième nom en dessous du premier)")
titok_social = Social.find_by(name: "tiktok").update(header: "Ajoute ton pseudo TikTok", explanation: "Ouvre Tiktok et rend toi sur ton profile. Ton username est sous ta photo de profil")
twitter_social = Social.find_by(name: "twitter").update(header: "Ajoute ton pseudo twitter", explanation: "Ouvre Twitter et rend toi sur ton profile. Ton username se trouve en dessous de ton pseudo (le deuxième nom en dessous du premier)")
linkedin_social = Social.find_by(name: "linkedin").update(header: "Ajoute le lien de ton profil Linkedin", explanation: "Ouvre www.linkedin.com et rend toi sur ton profile. Clique en haut à droite sur 'Modifier le profil public et l'URL'. Copie & Colle ton URL")
website_social = Social.find_by(name: "website").update(header: "Ajoute le lien de ton site internet", explanation: "Ajoute l'URL de ton site internet")
text_social = Social.find_by(name: "text").update(header: "Ajoute ton numéro de téléphone", explanation: "Tu te souviens de ton numéro ?")
email_social = Social.find_by(name: "email").update(header: "Ajoute ton adresse mail", explanation: "Cela ouvrira un email avec ton mail en adresse de réception")
contact_social = Social.find_by(name: "contact").update(header: "Ajoute ta fiche contact", explanation: "Envie de partager ton contact complet plus facilement ? Remplis simplement les champs que tu désires partager")
youtube_social = Social.find_by(name: "youtube").update(header: "Ajoute le lien de ta chaîne Youtube", explanation: "Ouvre www.youtube.com et rend toi sur ta chaîne. Copie & colle le lien")
soundcloud_social = Social.find_by(name: "soundcloud").update(header: "Ajoute ton pseudo Soundclound", explanation: "Ouvre Soundcloud et rend toi sur ton profil. Ton username se trouve sous ta photo de profil")
spotify_social = Social.find_by(name: "spotify").update(header: "Ajoute ton pseudo Spotify", explanation: "Ouvre Spotify et rend toi sur la page Préférences puis Compte. Tu y trouveras ton nom d'utilisateur")
twitch_social = Social.find_by(name: "twitch").update(header: "Ajoute ton pseudo Twitch", explanation: "Ouvre Twitch et rend toi ton profil. Tu y trouveras ton nom d'utilisateurà droite de ta photo de profil")
whatsapp_social = Social.find_by(name: "whatsapp").update(header: "Ajoute ton numéro de téléphone", explanation: "Nous n'acceptons que les numéros français pour le moment.")
lien_social = Social.find_by(name: "lien").update(header: "Ajoute un lien personnalisé", explanation: "Tu as envie d'ajouter un lien custom ? Fais-toi plaisir !")
