...
text_social = Social.find_by(name: "text").update(header: "Ajoute ton numéro de téléphone", explanation: "Tu te souviens de ton numéro ? Pas besoin des +33...", kind: "username")
email_social = Social.find_by(name: "email").update(header: "Ajoute ton adresse mail", explanation: "Cela ouvrira un email avec ton mail en adresse de réception", kind: "username")
...
whatsapp_social = Social.find_by(name: "whatsapp").update(header: "Ajoute ton numéro de téléphone", explanation: "Nous n'acceptons que les numéros français pour le moment.", kind: "username")
